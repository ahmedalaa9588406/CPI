...
function CardSlider() {
  ...
  const handleCardClick = (id: number) => {
    ...
    if (id === 1) {
      router.push("/home/ES/WM/Solid_Waste_Collection");
    } else if (id === 2) {
      router.push("/home/ES/WM/Waste_Water_Treatment");
    } else if (id === 3) {
      router.push("/home/ES/WM/Solid_Waste_Recycling_Share");
    }
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Solid Waste Collection</h4>
            </div>
          </div>
