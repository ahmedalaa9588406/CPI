...
function CardSlider() {
  ...
  const handleCardClick = (id: number) => {
    ...
    if (id === 1) {
      router.push("/home/ESI/SI/Slum_Housholds");
    } else if (id === 2) {
      router.push("/home/ESI/SI/Youth_Unemployment");
    }
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Slum Housholds</h4>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Youth Unemployment</h4>
            </div>
          </div>
        </div>
      </div>
