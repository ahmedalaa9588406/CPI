          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            >
              <div className="flex flex-col items-center p-6">
                ...
                <h4 className="text-lg font-bold text-gray-800 mb-2">Physiscian Density</h4>
              </div>
            </div>
            ...
            >
              <div className="flex flex-col items-center p-6">
                ...
                <h4 className="text-lg font-bold text-gray-800 mb-2">Number of Public Libraries</h4>
              </div>
            </div>
          </div>
        </div>
