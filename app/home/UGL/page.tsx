        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Participation</h4>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Municipal Financing and Institutional Capacity</h4>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Governance of Urbanization</h4>
            </div>
          </div>
        </div>
      </div>
