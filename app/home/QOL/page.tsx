        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Health</h4>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Safety and Security</h4>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center p-6">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Public Space</h4>
            </div>
          </div>
        </div>
      </div>
